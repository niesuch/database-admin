...
$logger_history_query = new Logger(LOGS_LOG_HISTORY_QUERY);
...
$paginator = new Paginator(array(
    'base' => $logger_history_query->_log['base'],
    'table' => $logger_history_query->_log['table'],
    'data' => $logger_history_query->_log['fields']
        )
);
...
<body>
    <form method="POST" name="form" action="">
        <div class="menu">
            ...
            <b><a href="log_history_query.php" class="margin-left-20">Log history query</a></b>
        </div>
    </form>

    <h1>Log history query</h1>
            ...
            <table class="logs_table">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a href="?sort=base_name&order=ASC">&#x25B2;</a>
                            Base name
                            <a href="?sort=base_name&order=DESC">&#x25BC;</a>
                        </th>
                        <th>
                ...
                <tbody>
                    <?php for ($i = 0; $i < count($results); $i++) { ?>
                        <tr>
                            ...
                            <td><?php echo $results[$i]['base_name']; ?></td>
