...
$logger_query = new Logger(LOGS_LOG_QUERY);
...
$paginator = new Paginator(array(
    'base' => $logger_query->_log['base'],
    'table' => $logger_query->_log['table'],
    'data' => $logger_query->_log['fields']
        )
);
...
<body>
    <form method="POST" name="form" action="">
        <div class="menu">
            ...
            <b><a href="log_query.php" class="margin-left-20">Log query</a></b>
